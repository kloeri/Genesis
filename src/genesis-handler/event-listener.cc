...
EventListener::EventListener(void) : _terminate(false) {}
...
void EventListener::add_source(EventSource *source) {
  int fd(source->fd());
  _sources[fd] = source;
}

void EventListener::add_eventsource(EventManager *manager) {
...
void EventListener::add_event(const std::string &event) {
...
void EventListener::process_eventqueue(void) {
...
bool EventListener::terminate(void) const { return _terminate; }

void EventListener::terminate(const bool value) { _terminate = value; }
